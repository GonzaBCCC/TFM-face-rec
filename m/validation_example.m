...
% load data
[X y width height names] = read_images('C:\dev\facerec\MIT-test_dist');
...
cv1 = KFoldCV(X,y,20,eigenfaces_train, eigenfaces_test, 0, 1);
% tpr = tp / (tp+fp)
...
% a 10-fold cross validation (per fold=0, debug=1)
cv2 = KFoldCV(X,y,36, fisherfaces_train, fisherfaces_test, 0, 1);
